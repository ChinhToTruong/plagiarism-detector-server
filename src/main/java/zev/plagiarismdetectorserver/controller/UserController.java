...
public class UserController {
  ...
  public ResponseData<?> updateUserByUserId(@Valid @RequestBody UpdateProfileUserRequest request,
  ...
  public ResponseData<?> searchUsers(@RequestParam(defaultValue = "0", required = false) int pageNo,
